(function ()
{
     ...
     *            'appConstants' module
     */
    function IoTController($timeout, $log, $rootScope, $scope, $http, CONST)
    {
        $rootScope.title = 'IoT';
        $scope.error = '';
         ...
         * 
         * vm.durations = [ { label : 'Last 5 Years', value : 'last5Years' }, {
         * label : 'Last 1 Year', value : 'last1Year' }, { label : 'Last 6
         * Months', value : 'last6Months' }, { label : 'Last 90 Days', value :
         * 'last90Days' }, { label : 'Last 60 Days', value : 'last60Days' }, {
         * label : 'Last 30 Days', value : 'last30Days' }, { label : 'Last 21
         * Days', value : 'last21Days' }, { label : 'Last 7 Days', value :
         * 'last7Days' }, { label : 'Last 3 Days', value : 'last3Days' }, {
         * label : 'Last Day', value : 'lastDay' }, { label : 'Last 24 Hours',
         * value : 'last24Hours' }, { label : 'Last 12 Hours', value :
         * 'last12Hours' }, { label : 'Last 6 Hours', value : 'last6Hours' }, {
         * label : 'Last Hour', value : 'lastHour' }]; vm.duration =
         * vm.durations[12]; // default
         */
         ...
         * 
         * @param duration
         *            {string} - The duration for the temperature data.
         */
        vm.getTemperatureData = function (duration)
        {
            ...
            var url = CONST.TEMPERATURE_REST_URL + '?duration=' + vm.duration.value;
            ...
            try
            {
                ...
                }).then(function successCallback(response)
                {
                    ...
                    {
                        var i, element, nrElements, dataArray;
                        dataArray= response.data.data;
                        nrElements = dataArray.length;
                        for (i = 0; i < nrElements; i++)
                        {
                            element = dataArray[i];
                            vm.sensorData.push(new SensorTemperature(i, element.unit,
    ...
    IoTController.$inject =
    [ '$timeout', '$log', '$rootScope', '$scope', '$http', 'CONST' ];
