(function ()
{
    ...
    function utilSvc($document, $log, $http, CONST)
    {
         ...
         * 
         * @param value
         *            {*} - The value reference to check for a number.
         * @throws {TypeError}
        ...
        /**
         * Validates the input value to ensure it contains enough text
         * characters to be considered a valid searchable text.
         * 
         * @param {string} -
         *            The text value to validate.
         * @throws {TypeError}
         *             Argument value must be a valid searcheable text
         */
        function isSearchText(value)
        {
            ...
            else
            {
                ...
                {
                    msg = 'argument given needs to have at least [' + CONST.MIN_SEARCH_TEXT_LEN
                            + '] characters';
                    $log.error(msg);
                    throw new TypeError(msg);
                }
         ...
         *            the div dom id
         * @throws {TypeError} --
         *             if element value given is not right type
         */
        function getElementById(value)
        {
            $log.debug('checking if [' + value + '] is found in the current page DOM');
            ...
            {
                msg = 'argument given needs to have at least [' + CONST.MIN_ELEMENT_TEXT_LEN + '] characters';
                $log.error(msg);
                throw new TypeError(msg);
            }
            ...
            if ( !dom_elem )
            {
                $log.error('element with id [' + element_id + '] not found in the current page DOM.');
            }

            var elem = angular.element(dom_elem);
            if ( !elem )
            {
                $log.error('angular element with id [' + element_id + '] not found in the current page DOM.');
            }
